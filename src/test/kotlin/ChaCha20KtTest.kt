...
class ChaCha20KtTest {
    ...
    fun chacha20Block232() {
        ...
        assertEquals(expected.size, processed.size, "Length of result")
        for (i in 0..expected.size - 1) {
            assertEquals(expected.get(i).toString(16), processed.get(i).toString(16), "Error in byte " + i)
        }
    }
    ...
    fun chacha20Encrypt242() {
        ...
        assertEquals(expected.size, ctBytes.size, "Length of result")
        for (i in 0..expected.size - 1) {
            assertEquals(expected.get(i).toString(16), ctBytes.get(i).toString(16), "Error in byte " + i)
        }
    }
    ...
    fun chacha20Decrypt242() {
        ...
        val expected =
            "Ladies and Gentlemen of the class of '99: If I could offer you only one tip for the future, sunscreen would be it."
                .toTypedIntArray()
        assertEquals(expected.size, ptBytes.size, "Length of result")
        for (i in 0..expected.size - 1) {
            assertEquals(expected.get(i).toString(16), ptBytes.get(i).toString(16), "Error in byte " + i)
        }
    }
    ...
    fun poly1305KeyGen262() {
        ...
        assertEquals(expected.size, key.size, "Length of result")
        for (i in 0..expected.size - 1) {
            assertEquals(expected.get(i).toString(16), key.get(i).toString(16), "Error in byte " + i)
        }
    }
    ...
    fun poly1305MAC252() {
        ...
        assertEquals(expected.size, mac.size, "Length of result")
        for (i in 0..expected.size - 1) {
            assertEquals(expected.get(i).toString(16), mac.get(i).toString(16), "Error in byte " + i)
        }
    }
    ...
    fun chacha20AEADEncrypt282() {
        ...
        assertEquals(expectedMAC.size, mac.size, "Length of mac")
        for (i in 0..expectedMAC.size - 1) {
            assertEquals(expectedMAC.get(i).toString(16), mac.get(i).toString(16), "Error in byte " + i)
        }

        assertEquals(expectedTAG.size, tag.size, "Length of tag")
        for (i in 0..expectedTAG.size - 1) {
            assertEquals(expectedTAG.get(i).toString(16), tag.get(i).toString(16), "Error in byte " + i)
        }
    }
    ...
    fun chacha20AEADecrypt282() {
        ...
        assertTrue(success, "Decryption error")

        assertEquals(expectedAAD.size, aad.size, "Length of AAD")
        for (i in 0..expectedAAD.size - 1) {
            assertEquals(expectedAAD.get(i).toString(16), aad.get(i).toString(16), "Error in AAD byte " + i)
        }

        assertEquals(expectedMSG.size, msg.size, "Length of msg")
        for (i in 0..expectedMSG.size - 1) {
            assertEquals(expectedMSG.get(i).toString(16), msg.get(i).toString(16), "Error in MSG byte " + i)
        }
    }
    ...
    fun testVectorA1_1() {
        ...
        assertEquals(expected.size, block.size, "Length of block")
        for (i in 0..expected.size - 1) {
            assertEquals(expected.get(i).toString(16), block.get(i).toString(16), "Error in byte " + i)
        }
    }
    ...
    fun testVectorA2_1() {
        ...
        assertEquals(expected.size, cyphertext.size, "Length of cyphertext")
        for (i in 0..expected.size - 1) {
            assertEquals(expected.get(i).toString(16), cyphertext.get(i).toString(16), "Error in byte " + i)
        }
    }
    ...
    fun testVectorA3_1() {
        ...
        assertEquals(expected.size, tag.size, "Length of tag")
        for (i in 0..expected.size - 1) {
            assertEquals(expected.get(i).toString(16), tag.get(i).toString(16), "Error in byte " + i)
        }
    }
    ...
    fun testVectorA4_1() {
        ...
        assertEquals(expected.size, onetimekey.size, "Length of one time key")
        for (i in 0..expected.size - 1) {
            assertEquals(expected.get(i).toString(16), onetimekey.get(i).toString(16), "Error in byte " + i)
        }
    }
